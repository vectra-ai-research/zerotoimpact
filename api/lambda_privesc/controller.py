...
def create(id, profile, aws_region):
    ...
    create = CreateLambdaPriEsc(id, profile, aws_region, instance_path)
    create.create()
...
def attack(id, profile, aws_region):
    ...
    attack_region = instance.get('region') or aws_region
    attack = AttackLambdaPriEsc(id, attack_region, instance, instance_path)
    attack.attack()
...
def destroy(id, profile, aws_region):
    ...
    destroy_region = instance.get('region') or aws_region
    destroy = DestroyLambdaPriEsc(id, profile, destroy_region, instance, instance_path)
    destroy.destroy()
